 ...
 * @author Andre
 */
public class SET_Table_8 extends JPanel {
    ...
    public void GNE_TABLE_1(final JTable table, TableModel model, int filterType, final int[] jumpColumn, final JTextField... textFields) throws SQLException {
