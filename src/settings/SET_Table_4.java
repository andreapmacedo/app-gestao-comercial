...
public class SET_Table_4 {
    ...
    public void loadTableGeneric(final JTable table, TableModel model, final int jumpC[],final JTextField z , final JTextField x[]) {
        ...
        z.setText(String.valueOf(Integer.valueOf(table.getRowCount()))); //x[0].setText(String.valueOf(Integer.valueOf(table.getRowCount()))); // esse é por definção o textf do número de itens
