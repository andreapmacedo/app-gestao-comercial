...
public class PhoneTable {
    ...
    public PhoneTable(JTable table) throws SQLException {
    ...
    public void loadTable() throws SQLException {
        ...
        list = new ArrayList(itemDAO.Select_idFK(EmployeeInfo.idEmployer));
    ...
    public void reloadTable(final JTextField contItens, ArrayList attr, ArrayList fieldsFilter) throws SQLException {
        ...
        System.out.println("dentro do reload o idfk: " + EmployeeInfo.idEmployer);
