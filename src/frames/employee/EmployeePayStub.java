...
public class EmployeePayStub extends JPanel {

    private EmployeePayStubItem cmpItens;
    private CMP_TBL_EVOTable gneTable;
    private EmployeeAddPayStub frmAdd;

    public PayStubDAO itemDAO;
    public JTable table;
    ...
    public EmployeePayStub() throws SQLException, ParseException {
...
//        });
    ...
    private void callAdd(int callType) throws SQLException, ParseException {
        ...
        frmAdd = new EmployeeAddPayStub(this, callType);
