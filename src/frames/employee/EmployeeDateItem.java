...
public class EmployeeDateItem extends JPanel {
    ...
    private EmployeeDate frmMain;
    List<EmployeeData> list;

    GridBagConstraints gbl = new GridBagConstraints(); //Restriçoes

    EmployeeDateItem(EmployeeDate frmMain) throws SQLException {
...
//        pnlPersonalInfo.add(txtEmployer, gbl);
    ...
    private void loadCmbEstate() throws SQLException {
        ...
        EstateDAO itemDAO = new EstateDAO();
    ...
    private void loadCmbCity(int idFk) throws SQLException {
        ...
        CityDAO itemDAO = new CityDAO();

        cmbCidade.removeAllItems();

        Vector<City> list = new Vector(itemDAO.get_JustFk_Entity_OrderByItemName(idFk));
        ...
        cmbEstado.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    Logger.getLogger(EmployeeDateItem.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
