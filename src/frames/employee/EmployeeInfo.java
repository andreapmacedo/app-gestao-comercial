...
import frames.employee.emp.EmployeePanel;
...
public class EmployeeInfo extends JFrame {
    ...
    public EmployeeMainItem pnlFields;
   ...
   // private String idFk, fkIdentify;
    ...
    public EmployeeInfo(int idMain, String identifyMain) throws SQLException, ParseException {

        EmployeeInfo.idEmployer = idMain;
        EmployeeInfo.identifyEmployer = identifyMain;
    ...
    public void initComps() throws SQLException, ParseException {
        ...
        pnlFields = new EmployeeMainItem();
      ...
      //  pnlSelectedItens = new EMP_GNE_PNL_SelectedIten();
        ...
        tbnPersonal.addTab("Informações Pessoais", new EmployeeDate());
        tbnPersonal.addTab("Contatos", new EmployeePhone());
        tbnFinancial.addTab("Vínculos", new EmployeePanel());
