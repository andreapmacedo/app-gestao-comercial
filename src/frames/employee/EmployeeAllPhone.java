...
public class EmployeeAllPhone extends JFrame {

    private EmployeePhoneItens cmpItens;
    private CMP_TBL_EVOTable gneTable;
    public AllPhoneTable setTable;
  ...
  //  private List<EmployersPhone> list;
    ...
    public EmployeeAllPhone() throws SQLException, ParseException {
    ...
    private void initComps() throws SQLException, ParseException {
        ...
        table = new JTable();
        setTable = new AllPhoneTable(table);
        ...
        gneTable.cmpConfigFilter.cmdClean.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    Logger.getLogger(EmployeeAllPhone.class.getName()).log(Level.SEVERE, null, ex);
                }
