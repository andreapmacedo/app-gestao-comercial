...
public class FrontEmployee extends JFrame {


    

    private EmployeeMainItem cmpItens;
    private CMP_TBL_EVOTable gneTable;
    private EmployeeAddMain frmAdd;
    private EmployerDAO itemDAO;
    private MainTable setTable;
    public JTable table;
    public int status = 1;

    public FrontEmployee() throws SQLException, ParseException {
    ...
    private void initComps() throws SQLException, ParseException {
        ...
        cmpItens = new EmployeeMainItem();
        table = new JTable();
        setTable = new MainTable(table, status);
        ...
        gneTable.cmpCrud.cmdInformations.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    EmployeeInfo dialog = new EmployeeInfo(Integer.parseInt(gneTable.cmpSelectedIten.idSelectedRow), gneTable.cmpSelectedIten.txtSelectedItem.getText());
    ...
    private void callAdd(int callType) throws SQLException, ParseException {
        ...
        frmAdd = new EmployeeAddMain(this, callType);
