...
public class EmployeeAddMain extends JFrame {

    public CMP_BasicCRUD cmpCrud;
    public EmployeeMainItem cmpItens;
    private EmployerDAO itemDAO = new EmployerDAO();
    private Employees item = new Employees();
    public FrontEmployee frmMain;
    private JTable table;
    public int switchComand = 0;
    private SET_TextField_ID_1 setConf_ID_1;
    DateFormat formatador = new SimpleDateFormat("dd-MM-yyyy");

    public EmployeeAddMain(FrontEmployee frmMain, int switchComand) throws SQLException, ParseException {
