...
public class EmployeePayStubItem extends JPanel {
    ...
    public EmployeePayStubItem() throws ParseException, SQLException {
        configShow();
        initComps();
        setDefault();
        event();
...
//        });
        cmbDescription.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                PayStubDescriptionDAO itenDAO = new PayStubDescriptionDAO();

                int idFk = itenDAO.get_Id_Entity((String) cmbDescription.getSelectedItem());

                if (cmbDescription.getSelectedIndex() != -1) {

                    PayStubDescription iten;
...
//                        System.out.println("temp " + temp);
                        ...
                        Logger.getLogger(EmployeePayStubItem.class.getName()).log(Level.SEVERE, null, ex);
                    }
