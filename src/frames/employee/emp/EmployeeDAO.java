...
public class EmployeeDAO extends GenericDAO {
    ...
    public void add_Entity(Employee entity, int[] attr) throws SQLException {
...
//        query = query + values + " )";
    ...
    public void update_Entity(Employee entity, int[] attr) throws SQLException {
...
//        query = query + " WHERE " + attrb[0] + " = ?";
    ...
    public Employee select_By_idPk(int idPk) throws SQLException {
    ...
    public Employee select_ID(int idFk) throws SQLException {//provavel necessidade de alteração
    ...
    public List<Employee> Select_By_idFK_1(int idFK) throws SQLException {
    ...
    public List<Employee> select_All() throws SQLException {
    ...
    public List<Employee> select_Filter(int idFk, ArrayList attr, ArrayList fieldsFilter) throws SQLException {
...
//
//    }
    public static Object[][] populateTable(List<Employee> lista, int loadRef) {
    ...
    public Employee setEntity(ResultSet rs, int loadRef) throws SQLException {
