...
public class EmployeeDAO extends GenericDAO {
    ...
    public void addServidores(Employee servidores) throws SQLException {
    ...
    public void updateServidores(Employee servidores) throws SQLException {
    ...
    public Employee getServidor(int idServidor) throws SQLException {

        ResultSet rs = executeQuery("SELECT * FROM TB_SERVIDORES WHERE SER_CODIGO = ?", idServidor);


        Employee servidores = null;
        if (rs.next()) {
    ...
    public List<Employee> geAllServidores() throws SQLException {
    ...
    public List<Employee> getListServidores() throws SQLException {
    ...
    public Employee populateServidoresInfo(ResultSet rs) throws SQLException {
