...
public class PayStubDescriptionDAO extends GenericDAO {
    ...
    public void add_Entity(PayStubDescription entity) throws SQLException {
    ...
    public void update_Entity(PayStubDescription entity) throws SQLException {
    ...
    public PayStubDescription Select_Iten_By_idFK(int idPk) throws SQLException {

        ResultSet rs = executeQuery("SELECT * FROM " + tableName + " WHERE " + attrb[0] + " = ?", idPk);

        PayStubDescription iten = null;
        if (rs.next()) {
    ...
    public PayStubDescription get_Iten_Entity_1(int idPk) throws SQLException {
...
//        return entity;
//    }
    public List<PayStubDescription> get_All_Entity_OrderByItemName() throws SQLException {

        ResultSet rs = executeQuery("Select * From " + tableName + " Order By " + mainName + ";");
        List<PayStubDescription> toReturn = new LinkedList<PayStubDescription>();
        while (rs.next()) {
    ...
    public List<PayStubDescription> get_All_Entity_SQLdefault() throws SQLException {
    ...
    public int get_Id_Entity(String itemCmb) {
        ...
        try {
            ...
            Vector<PayStubDescription> list = new Vector(this.get_All_Entity_OrderByItemName());
    ...
    public static Object[][] getFromRAM(List<PayStubDescription> lista) {
        ...
        for (int i = 0; i < resposta.length; i++) {
            PayStubDescription entity = lista.get(i);
    ...
    public PayStubDescription getFromSQL(ResultSet rs, int loadGetType) throws SQLException {

        PayStubDescription entity = new PayStubDescription();
