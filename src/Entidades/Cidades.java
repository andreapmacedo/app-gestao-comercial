...
public class Cidades {
    ...
    public Cidades(Integer idCidade, String nomeCidade, Integer idEstado) {
    ...
    public Cidades(Integer idCidade, String nomeCidade, Integer idEstado, String nomeEstado) {
        this.idCidade = idCidade;
        this.nomeCidade = nomeCidade;
        this.idEstado = idEstado;
    ...
    public Cidades(Integer idCidade, String nomeCidade, String nomeEstado) {
        this.idCidade = idCidade;
        this.nomeCidade = nomeCidade;
        this.nomeEstado = nomeEstado;
    }
    ...
    public Cidades(Integer idCidade, Integer idEstado) {
        this.idCidade = idCidade;
        this.idEstado = idEstado;
    }
