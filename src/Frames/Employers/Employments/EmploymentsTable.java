...
public class EmploymentsTable extends GenericTableModel1 {

    EmploymentsDAO itemDAO;
    final String[] columnNames = {"COD", "INÍCIO", "TERMINO", "SITUAÇÃO"};


    public EmploymentsTable() throws SQLException, ParseException {
