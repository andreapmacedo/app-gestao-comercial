...
public class EMP_HOL_DESCRIPTION_ADD extends JFrame {

    public EMP_HOL_DESCRIPTION_ITENS cmpItens;
    public HoleriteDescription iten = new HoleriteDescription();
    public HoleriteDescriptionDAO itenDAO = new HoleriteDescriptionDAO();
//    private JTable table;
    private String idFk, txtIdentify;
    private int formFrom;
    private final int ADD = 0;
    private final int UPDATE = 1;
    EMP_HOLERITE_ITENS itenHoleriteItens;
//
...
//
    EMP_HOLERITE_ADD formHoleriteAdd;

    public CMP_BasicCRUD cmpCrud;
    public int callType = 0;

    public EMP_HOL_DESCRIPTION_ADD(EMP_HOLERITE_ADD formHoleriteAdd, int callType) throws SQLException, ParseException {
...
//    }
    public void initComps() throws SQLException, ParseException {
        ...
        cmpItens = new EMP_HOL_DESCRIPTION_ITENS();
...
//precisamos do idpk para caso de update
                ...
                try {
                    ...
                    Logger.getLogger(EMP_HOL_DESCRIPTION_ADD.class.getName()).log(Level.SEVERE, null, ex);
                }
                dispose();
