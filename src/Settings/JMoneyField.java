...
public class JMoneyField extends JFormattedTextField {
    ...
    // a inicialização dessa classe se dá da seguinte forma:
    //private JFormattedTextField mf;
    //mf = new JMoneyField();
    //pane.add(mf);
    ...
    public JMoneyField() {
        ...
        //this.setPreferredSize(new Dimension(110, 30));//Dimension btmPreferedSize = (new Dimension(123, 63));
        this.setText("0,00");
