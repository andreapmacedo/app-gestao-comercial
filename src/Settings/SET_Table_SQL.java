...
public class SET_Table_SQL {
    ...
    public void loadTableGeneric(final JTable table, TableModel model, final int index_Filter_AutoMan, 
            final int index_Filter_FullPart, final int[] jumpColumn, final JComboBox cmbAutoMan, 
            final JComboBox cmbFullPart, JButton cmdSearch, final JTextField contItens, final String[] fieldsItems) {
