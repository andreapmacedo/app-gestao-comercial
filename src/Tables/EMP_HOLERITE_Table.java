...
public class EMP_HOLERITE_Table {

    private Holerite iten = new Holerite();
    public JTable table;
    public DefaultTableModel model;
    private HoleriteDAO itemDAO;
    private final String[] columnNames = {"COD", "DESCRIÇÃO", "Vr. REF.", "REFERÊNCIA", "VENCIMENTO", "DESCONTO", "INCIDÊNCIA"};
    private List<Holerite> list;

    public EMP_HOLERITE_Table(JTable table, String idFk) throws SQLException {
