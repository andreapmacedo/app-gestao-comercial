...
public class EmployerPhoneDAO extends GenericDAO {
    ...
    public void add_Entity(EmployersPhone entity) throws SQLException {
    ...
    public void update_Entity(EmployersPhone entity) throws SQLException {
    ...
    public EmployersPhone select_idPk(int idPk) throws SQLException {

        ResultSet rs = executeQuery("SELECT * FROM " + tableName + " WHERE " + attrb[0] + " = ?", idPk);

        EmployersPhone entity = null;
        if (rs.next()) {
    ...
    public List<EmployersPhone> Select_idFK(int idFK) throws SQLException {

        ResultSet rs = executeQuery(" Select * From tb_employers_phone WHERE  EFN_EMP_ID  = ? ", idFK);
        List<EmployersPhone> toReturn = new LinkedList<EmployersPhone>();
    ...
    public List<EmployersPhone> select_full() throws SQLException {
    ...
    public List<EmployersPhone> select_Filter(int idFk, ArrayList attr, ArrayList fieldsFilter) throws SQLException {
    ...
    public List<EmployersPhone> select_Inner() throws SQLException {
    ...
    public List<EmployersPhone> select_InnerFilter(boolean status, ArrayList attr, ArrayList fieldsFilter) throws SQLException {
    ...
    public static Object[][] populateTable_1(List<EmployersPhone> lista) {
        ...
        for (int i = 0; i < resposta.length; i++) {
            EmployersPhone entity = lista.get(i);
    ...
    public static Object[][] populateTable_2(List<EmployersPhone> lista) {
    ...
    public EmployersPhone get_Entity(ResultSet rs, int loadGetType) throws SQLException {

        EmployersPhone toReturn = new EmployersPhone();
