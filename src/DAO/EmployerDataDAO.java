...
public class EmployerDataDAO extends GenericDAO {
    ...
    public void add_Entity(EmployerData entity) throws SQLException {
...
//        query = query + values + " )";
    ...
    public void update_Entity(EmployerData entity) throws SQLException {
...
//        query = query + " WHERE " + attrb[0] + " = ?";
    ...
    public EmployerData select_By_idPk(int idPk) throws SQLException {

        ResultSet rs = executeQuery("SELECT * FROM " + tableName + " WHERE " + attrb[0] + " = ?", idPk);

        EmployerData entity = null;
        if (rs.next()) {
    ...
    public EmployerData select_ID(int idFk) throws SQLException {
    ...
    public List<EmployerData> Select_By_idFK(int idFK) throws SQLException {

        String query = "call upAllAgeEmployer";
        executeCommand(query);

        ResultSet rs = executeQuery(" Select * From " + tableName + " WHERE  " + attrb[1] + "  = ? ", idFK);
        List<EmployerData> toReturn = new LinkedList<EmployerData>();
    ...
    public List<EmployerData> select_All() throws SQLException {
    ...
    public List<EmployerData> select_Filter(int idFk, ArrayList attr, ArrayList fieldsFilter) throws SQLException {
    ...
    public List<EmployerData> select_Inner() throws SQLException {
    ...
    public List<EmployerData> select_Inner_Filter(boolean status, ArrayList attr, ArrayList fieldsFilter) throws SQLException {
    ...
    public static Object[][] populateTable_1(List<EmployerData> lista) {
...
//            resposta[i][2] = entity.getNascimento();
    ...
    public static Object[][] populateTable_2(List<EmployerData> lista) {
...
//            resposta[i][2] = entity.getNascimento();
    ...
    public EmployerData setEntity(ResultSet rs, int loadGetType) throws SQLException {

        EmployerData toReturn = new EmployerData();
