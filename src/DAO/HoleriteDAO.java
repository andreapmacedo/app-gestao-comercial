...
public class HoleriteDAO extends GenericDAO {
    ...
    public void add_Entity(Holerite entity) throws SQLException {
...
//        query = query + values + " )";
    ...
    public void update_Entity(Holerite entity) throws SQLException {
...
//        query = query + " WHERE " + attrb[0] + " = ?";
    ...
    public Holerite select_By_idPk(int idPk) throws SQLException {

        ResultSet rs = executeQuery("SELECT * FROM " + tableName + " WHERE " + attrb[0] + " = ?", idPk);

        Holerite entity = null;
        if (rs.next()) {
    ...
    public Holerite select_ID(int idFk) throws SQLException {
    ...
    public List<Holerite> Select_By_idFK(int idFK) throws SQLException {
    ...
    public List<Holerite> select_All() throws SQLException {
    ...
    public List<Holerite> select_Inner() throws SQLException {
...
//
//    }
    public List<Holerite> select_InnerFilter(int idFk, ArrayList attr, ArrayList fieldsFilter) throws SQLException {
...
//        }
    ...
    public static Object[][] populateTable_1(List<Holerite> lista) {
    ...
    public static Object[][] populateTable_2(List<Holerite> lista) {
    ...
    public Holerite setAtributes(ResultSet rs, int loadGetType) throws SQLException {

        Holerite toReturn = new Holerite();
